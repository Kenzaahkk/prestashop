...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[ORM\OneToMany(mappedBy: 'prestataire', targetEntity: Prestation::class, cascade: ['persist', 'remove'])]
    private Collection $prestations;

    #[ORM\OneToMany(mappedBy: 'client', targetEntity: Demande::class, cascade: ['persist', 'remove'])]
